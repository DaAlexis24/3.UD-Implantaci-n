...
export class ReviewsController {
  ...
  async getAllFilmsReviews(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      if (
        ...
        log('Error getting all film reviews: %s', notFoundError.message);
  ...
  async getAllUserReviews(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      if (
        ...
        const notFoundError = new NotFoundError('User requested not found', {
          cause: error,
        });
        log('Error getting all user reviews: %s', notFoundError.message);
        return next(notFoundError);
      }
  ...
  async createReview(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const internalError = new InternalServerError('Failed to create review', {
        cause: error,
      });
  ...
  async updateReview(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      if (
        ...
        const notFoundError = new NotFoundError('Review requested not found', {
          cause: error,
        });
      ...
      const internalError = new InternalServerError('Failed to update review', {
        cause: error,
      });
  ...
  async deleteReview(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const internalError = new InternalServerError('Failed to delete review', {
        cause: error,
      });
