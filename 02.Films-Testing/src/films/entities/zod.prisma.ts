...
type _FilmCreateDTOCheck = Assert<IsExact<FilmCreateDTO, FilmCreateShape>>;

type _FilmUpdateDTOCheck = Assert<IsExact<FilmUpdateDTO, FilmUpdateShape>>;

type _FilmParamsDTOCheck = Assert<IsExact<FilmParamsDTO, FilmParamsShape>>;
