...
export class UsersController {
  ...
  async register(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const internalError = new InternalServerError('Failed to register user', {
        cause: error,
      });
  ...
  async login(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const internalError = new InternalServerError('Failed to login user', {
        cause: error,
      });
  ...
  async getAllUsers(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const internalError = new InternalServerError('Failed to get all users', {
        cause: error,
      });
  ...
  async updateUser(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      const internalError = new InternalServerError('Failed to update user', {
        cause: error,
      });
      if (
        error instanceof PrismaClientKnownRequestError &&
        ...
        const notFoundError = new NotFoundError('User for update not found', {
          cause: error,
        });
  ...
  async deleteUser(req: Request, res: Response, next: NextFunction) {
    try {
      ...
      if (
        ...
        const notFoundError = new NotFoundError('User for delete not found', {
          cause: error,
        });
      ...
      const internalError = new InternalServerError('Failed to delete user', {
        cause: error,
      });
